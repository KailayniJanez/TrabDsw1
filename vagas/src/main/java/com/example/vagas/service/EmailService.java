...
public class EmailService {
    ...
    public void enviarEmailConfirmacaoCandidatura(String emailDestino, String tituloVaga, String nomeEmpresa) {
    SimpleMailMessage message = new SimpleMailMessage();
    message.setTo(emailDestino);
    message.setSubject("Confirmação de Candidatura");
    
    String texto = "Sua candidatura para a vaga '" + tituloVaga + "'\n"
                 + "na empresa " + nomeEmpresa + " foi recebida com sucesso!\n\n"
                 + "Agradecemos seu interesse e entraremos em contato em breve.\n\n"
                 + "Atenciosamente,\nEquipe Vagas Online";
